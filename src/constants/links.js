export const LINK_WELCOME = '/';
export const LINK_BACKGROUND = '/background';
export const LINK_AUTH = '/auth';
export const LINK_USER_INFO = '/user-info';
...
export const LINK_LIST_CHESS_BOARD = '/list-chess-board';
